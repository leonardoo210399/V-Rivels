        ...
        <div className="space-y-8 rounded-xl border border-white/5 bg-slate-900/50 p-8 text-sm leading-relaxed md:p-12 md:text-base">
          <section>
            ...
            <p className="text-slate-400">
              ...
              https://vrivalsarena.com (hereinafter referred to as Platform).
          ...
          <section>
            ...
            <p className="text-slate-400">
              ...
              any such information shared as proof of identity or address. Some
              of the sensitive personal data may be collected with your consent,
            ...
            <p className="mt-4 text-slate-400">
              ...
              to be VRivals Arena seeking any personal data like debit/credit
              card PIN, net-banking or mobile banking password, we request you
              to never provide such information. If you have already revealed
          ...
          <section>
            ...
            <div className="mt-4 inline-block rounded-lg bg-slate-800/50 p-4 text-slate-300">
              <p className="mb-1">
                <span className="font-bold text-white">Name:</span> VRivals
                Arena Support
              </p>
              <p className="mb-1">
                <span className="font-bold text-white">Entity Address:</span>{" "}
              ...
              <p className="mb-1">
                ...
                <span className="text-rose-400">9356832187</span> (9:00 - 18:00
                Mon-Fri)
              </p>
            </div>
          </section>
