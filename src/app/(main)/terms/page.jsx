    ...
    <div className="min-h-screen bg-slate-950 text-slate-200">
      ...
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        <div className="bg-slate-900/50 p-8 md:p-12 rounded-xl border border-white/5 text-sm md:text-base leading-relaxed space-y-8">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-white mb-4 border-l-4 border-rose-500 pl-4">2. Eligibility</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-white mb-4 border-l-4 border-rose-500 pl-4">3. Code of Conduct</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-white mb-4 border-l-4 border-rose-500 pl-4">4. Payments and Payouts</h2>
            <ul className="list-disc list-inside space-y-2 text-slate-400 ml-2">
              <li>Entry fees are non-refundable except as specified in our <Link href="/refund-policy" className="text-rose-500 hover:underline">Refund Policy</Link>.</li>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-white mb-4 border-l-4 border-rose-500 pl-4">6. Contact Information</h2>
