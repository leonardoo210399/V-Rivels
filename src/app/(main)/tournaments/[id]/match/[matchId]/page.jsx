                    ...
                    <div className="rounded-2xl border border-white/5 bg-slate-900/50 p-4 transition-colors hover:border-rose-500/30">
                      ...
                      <div className="flex items-center justify-between">
                        <button
                          ...
                          className="flex h-10 w-10 items-center justify-center rounded-lg bg-slate-800 font-bold text-white transition-all hover:bg-rose-500 hover:shadow-lg hover:shadow-rose-500/20"
                        >
                          -
                        </button>
                    ...
                    <div className="rounded-2xl border border-white/5 bg-slate-900/50 p-4 transition-colors hover:border-cyan-500/30">
                      ...
                      <div className="flex items-center justify-between">
                        <button
                          ...
                          className="flex h-10 w-10 items-center justify-center rounded-lg bg-slate-800 font-bold text-white transition-all hover:bg-cyan-500 hover:shadow-lg hover:shadow-cyan-500/20"
                        >
                          -
                        </button>
                        <span className="text-4xl font-black text-white italic">
