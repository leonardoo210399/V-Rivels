    ...
    <div className="min-h-screen bg-slate-950 text-slate-200">
      ...
      <div className="container mx-auto px-6 py-12 max-w-4xl">
        <div className="bg-slate-900/50 p-8 md:p-12 rounded-xl border border-white/5 text-sm md:text-base leading-relaxed space-y-8">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-white mb-4 border-l-4 border-teal-500 pl-4">1. General Policy</h2>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-white mb-4 border-l-4 border-teal-500 pl-4">2. Tournament Entry Fees</h2>
            <ul className="list-disc list-inside space-y-2 text-slate-400 ml-2">
              ...
              <li>
                <strong className="text-slate-200">Disqualification:</strong> Teams or players disqualified for violating our <Link href="/rules" className="text-teal-500 hover:underline">Rules & Regulations</Link> (cheating, toxicity, etc.) are <strong className="text-red-400">NOT</strong> eligible for refunds.
              </li>
              <li>
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-white mb-4 border-l-4 border-teal-500 pl-4">3. Subscription Services</h2>
            <p className="text-slate-400">
          ...
          <section>
            <h2 className="text-xl md:text-2xl font-bold text-white mb-4 border-l-4 border-teal-500 pl-4">4. Dispute Resolution</h2>
            <p className="text-slate-400">
          ...
          <section>
            ...
            <div className="mt-6">
                 <Link href="/support" className="inline-block bg-teal-600 hover:bg-teal-700 text-white font-bold py-3 px-6 rounded-lg transition-colors">
                    Go to Support Page
                 </Link>
            </div>
          </section>
